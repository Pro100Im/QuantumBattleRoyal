...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct CooledDownState {
  ...
  public unsafe partial struct CircleStateUnion {
    ...
    [FieldOffset(8)]
    [FieldOverlap(8)]
    [FramePrinter.PrintIf("_field_used_", Quantum.CircleStateUnion.COOLEDDOWNSTATE)]
    private CooledDownState _CooledDownState;
    public const Int32 INITIALSTATE = 1;
    public const Int32 PRESHRINKSTATE = 2;
    public const Int32 SHRINKSTATE = 3;
    public const Int32 COOLEDDOWNSTATE = 4;
    ...
    public CooledDownState* CooledDownState {
      get {
        fixed (CooledDownState* p = &_CooledDownState) {
          if (_field_used_ != COOLEDDOWNSTATE) {
            Native.Utils.Clear(p, 4);
            _field_used_ = COOLEDDOWNSTATE;
          }
          return p;
        }
      }
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + _CooledDownState.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        if (serializer.InputMode) {
          serializer.Stream.SerializeBuffer((byte*)p, Quantum.CircleStateUnion.SIZE);
          return;
        }
        serializer.Stream.Serialize(&p->_field_used_);
        if (p->_field_used_ == COOLEDDOWNSTATE) {
          Quantum.CooledDownState.Serialize(&p->_CooledDownState, serializer);
        }
  ...
  public unsafe partial struct CharacterStats : Quantum.IComponent {
    ...
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetRef<CharacterStatsAsset> CharacterStatsAsset;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 18671;
        hash = hash * 31 + CharacterStatsAsset.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (CharacterStats*)ptr;
        AssetRef.Serialize(&p->CharacterStatsAsset, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Damageable : Quantum.IComponent {
    ...
    public FP Health;
    [FieldOffset(0)]
    public AssetRef<DamageableBaseAsset> DamageableData;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 21187;
  ...
  public unsafe partial struct GameManager : Quantum.IComponentSingleton {
    ...
    [FieldOffset(8)]
    public AssetRef<GameManagerAsset> GameManagerAsset;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 14767;
        hash = hash * 31 + (Int32)currentState;
        hash = hash * 31 + TimeToWaitForPlayers.GetHashCode();
        hash = hash * 31 + GameManagerAsset.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        AssetRef.Serialize(&p->GameManagerAsset, serializer);
  ...
  public unsafe partial struct ShrinkingCircle : Quantum.IComponentSingleton {
    ...
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    public AssetRef<ShrinkingCircleAsset> Asset;
    [FieldOffset(64)]
  ...
  public unsafe partial interface ISignalDamageableHit : ISignal {
    void DamageableHit(Frame f, EntityRef vicitim, EntityRef damager, FP damage, Damageable* damageable);
  }
  ...
  public unsafe partial class Frame {
    ...
    public unsafe partial struct FrameSignals {
      public void DamageableHit(EntityRef vicitim, EntityRef damager, FP damage, Damageable* damageable) {
        var array = _f._ISignalDamageableHitSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.DamageableHit(_f, vicitim, damager, damage, damageable);
          }
        }
      }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.CooledDownState), Quantum.CooledDownState.SIZE);
