...
namespace Quantum.Prototypes {
  ...
  public unsafe partial class CharacterStatsPrototype : ComponentPrototype<Quantum.CharacterStats> {
    ...
    public void Materialize(Frame frame, ref Quantum.CharacterStats result, in PrototypeMaterializationContext context = default) {
        result.CharacterStatsAsset = this.CharacterStatsAsset;
  ...
  public unsafe partial class CircleStateUnionPrototype : UnionPrototype {
    ...
    public Quantum.Prototypes.CooledDownStatePrototype CooledDownState;
    ...
    public void Materialize(Frame frame, ref Quantum.CircleStateUnion result, in PrototypeMaterializationContext context = default) {
        switch (_field_used_) {
          ...
          case "COOLEDDOWNSTATE": this.CooledDownState.Materialize(frame, ref *result.CooledDownState, in context); break;
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.CooledDownState))]
  public unsafe partial class CooledDownStatePrototype : StructPrototype {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.CooledDownState result, in PrototypeMaterializationContext context);
    public void Materialize(Frame frame, ref Quantum.CooledDownState result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class GameManagerPrototype : ComponentPrototype<Quantum.GameManager> {
    public Quantum.QEnum32<GameState> currentState;
    ...
    public void Materialize(Frame frame, ref Quantum.GameManager result, in PrototypeMaterializationContext context = default) {
        ...
        result.GameManagerAsset = this.GameManagerAsset;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe class PickUpItemPrototype : ComponentPrototype<Quantum.PickUpItem> {
    public MapEntityId PickingUpEntity;
    ...
    public void Materialize(Frame frame, ref Quantum.PickUpItem result, in PrototypeMaterializationContext context = default) {
        PrototypeValidator.FindMapEntity(this.PickingUpEntity, in context, out result.PickingUpEntity);
        result.CurrentPickUpTime = this.CurrentPickUpTime;
        result.PickUpTime = this.PickUpTime;
        result.PickUpAsset = this.PickUpAsset;
    }
  }
  [System.SerializableAttribute()]
